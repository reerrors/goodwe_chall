...
<style>
    ...
    .section-title {
        ...
        border-bottom: 1.8px solid #4f4c4c !important; /* ALTERADO: Borda preta */
...
with col1:
    ...
    fig.add_trace(go.Scatter(
        ...
        name='Produção',
        line=dict(color="red", width=3), # ALTERADO: Cor da linha para preto
        fill='tozeroy',
        fillcolor='rgba(100, 0, 0, 0.2)' # ALTERADO: Cor do preenchimento para cinza
    ))
...
with tab1:
    ...
    fig_monthly.add_trace(go.Bar(x=months, y=production, name='Produção', marker_color='red'))
